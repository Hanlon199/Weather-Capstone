...
import {
  WiHumidity,WiWindy,WiBarometer,
  WiHot,WiSnow,WiDaySunny,
  WiWindDeg,WiStrongWind,
...
export default function CurrData() {
  ...
  const [chipData, setChipData] = useState([
    ...
    { key: 1, value:0, title:'RH', label: 'Humidity:', check: true, link: 'https://en.wikipedia.org/wiki/Relative_humidity', metricUnit: '%', imperialUnit: '%' },
      ...
      <Row>
              ...
              return (
                ...
                <Card className={classes.card} key={data.key}>
                  ...
                  <CardActions style={StyleSheet['cardStyle']}>
                    <a style={StyleSheet['info']} href={data.link} target="_blank"><GoInfo/></a>
                  </CardActions>
                </Card>
                // <Chip
                //   key={data.key}
        ...
        <Card className={classes.cardFilter}>
          <CardActions>
            ...
            <FormControlLabel
            control={
              <Switch checked={unitType === 'imperial'} onClick={handleUnitChange} value={unitType} />
            }
            label={unitType}
          />
          </CardActions>
